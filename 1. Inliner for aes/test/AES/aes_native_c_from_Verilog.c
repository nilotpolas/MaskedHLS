...
void GF_INV_8 ( ap_int<8> A, ap_int<8> Q ) {
//   input [7:0] A;
//   output [7:0] Q;
  ap_int<4> a, b, c, d, p, q;
  ap_int<2> sa, sb, sd, t; /* for shared factors in multipliers */ 
  ap_int<1> al, ah, aa, bl, bh, bb, dl, dh, dd; /* for shared factors */
  ap_int<1> c1, c2, c3; /* for temp var */
